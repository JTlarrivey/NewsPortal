...
export default function AdBanner({ position, imageUrl, link }: AdBannerProps) {
    ...
    'side': 'fixed right-0 top-1/2 -translate-y-1/2 w-[160px] mr-4',
    'bottom': 'fixed bottom-0 left-0 right-0 w-full h-[90px]'
    };
    ...
    return (
        <div className={`${positionClasses[position]} ${slideClasses[position]} z-40 group`}>
        <button
